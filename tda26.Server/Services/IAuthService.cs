...
public interface IAuthService {
    ...
    Task<Account?> RegisterAsync(string username, string email, string plainPassword, string firstName, string? middleName, string lastName, Guid organizationUuid, CancellationToken ct = default);
